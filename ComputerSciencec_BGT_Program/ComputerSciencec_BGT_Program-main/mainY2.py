...
class LeaderboardApp:
    ...
    def update_leaderboard(self):
        ...
        self.players_points_info_Y2["TotalGlobalPoints"] = sum(self.players_points_info_Y2.values())
        self.players_points_info_Y2["NumberOfPlayers"] = len(self.players_points_info_Y2)
